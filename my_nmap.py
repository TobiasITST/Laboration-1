...
def my_nmap(result_dict, ip_list):
    ...
    try:
        ...
        # Check for arguments
        # Challangening to check for correct port format
        ...
        # Would implement as an option otherwise for -O as an example
        
        # while True:
        #         usr_input = input("Run nMap search as 'Sudo' (Y/N)?: ").lower()
        #         if usr_input == "y" or usr_input == "n":
        #             match usr_input:
        #                 case "y":
        #                     sudo = True
        ...
        if not arguments:
            result = nm.scan(hosts = host, arguments = " --unprivileged")
        elif arguments:
            arguments += " --unprivileged" 
            result = nm.scan(hosts = host, arguments = arguments)["scan"]
